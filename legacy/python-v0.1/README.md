...
This implementation is retained as design history. It does not implement the
current v0.2 format and should not be published as the current Python package.
...
```bash
uv run --project legacy/python-v0.1 pytest -q legacy/python-v0.1/tests
```
