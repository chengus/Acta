...
# ///
"""Generate and validate the `date32` primary-column Acta v0.2 fixture."""
...
def render_markdown(fixture: bytes, output_name: str) -> str:
    ...
    return f"""# `date32` primary-column Acta v0.2 fixture
...
[`format_v0.2.md`](../../format_v0.2.md) sections 3, 7, and 8. The file is a
...
def main() -> None:
    ...
    if not args.output and not args.markdown_output:
        print(
            f"Acta v0.2 date32 fixture passed: {len(fixture)} bytes, "
            f"sha256={digest}"
        )
